...
1. **[Lane Neverending Photo Archive](./examples/adventure-4/street/lane-neverending/slideshow/SLIDESHOW.md)** — Generated images with semantic mining layers
2. **[The Pub](./examples/adventure-4/pub/)** — Directories of YAML Jazz and README files, rooms you can explore
3. **[MOOLLM Interviews Itself](./examples/adventure-4/characters/real-people/don-hopkins/sessions/2026-01-28-moollm-interview.md)** — Narrative play, self-reflection, and an Irn Bru snowman flight
...
| **Designs** | [indexes/DESIGNS.md](./indexes/DESIGNS.md) — 135 docs: Sims archaeology, EVAL, ethics |
| **Sessions** | [indexes/SESSIONS.md](./indexes/SESSIONS.md) — 42+ sessions: epics, transformations |
| **Animals** | [indexes/ANIMALS.md](./indexes/ANIMALS.md) — 24 animals: Palm, Biscuit, cats, puppies |
| **Slideshows** | [indexes/SLIDESHOWS.md](./indexes/SLIDESHOWS.md) — 14 galleries, 100+ images |
| **Pioneers** | [indexes/PIONEERS.md](./indexes/PIONEERS.md) — 22+ giants we stand on |
| **All Indexes** | [indexes/](./indexes/) — consolidated reference lists |
...
Not just your last message — your whole story. Sessions become literature. Characters grow souls. The [pub](./examples/adventure-4/pub/) remembers who sat where. The [guestbook](./examples/adventure-4/pub/guestbook/) keeps their signatures.
...
See [indexes/PIONEERS.md](./indexes/PIONEERS.md) for the full genealogy.
