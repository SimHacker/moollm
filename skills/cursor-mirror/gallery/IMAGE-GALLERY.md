...
```
Session logs like [marathon-session.md](../../../examples/adventure-4/characters/real-people/don-hopkins/sessions/marathon-session.md) capture this dialogue. The "backseat
...
- **Palm (a monkey's paw incarnate) beat Andy Looney at his own game** 🐒🃏
