...
| [**supersession-suggestions.yml**](./supersession-suggestions.yml) | **Legacy → toward-now** hints (COM/OLE/XPCOM, SGML/DSSSL, SOAP, ActiveX)—not deprecation law; pairs with **gateways** and **formats** toolchains. |
