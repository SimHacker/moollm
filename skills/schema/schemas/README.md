...
| [**supersession-suggestions.yml**](./supersession-suggestions.yml) | **Multi-axis**: **toward_now**, **upwardish**, **sideways**, **roots_downward** per cluster (COM/OLE/XPCOM, SGML/DSSSL, SOAP, ActiveX)—not deprecation law; pairs with **gateways** and **formats** toolchains. |
