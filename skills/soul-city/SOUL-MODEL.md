...
|------|--------------------------|
| ***The Society of Mind*** — Marvin Minsky | Mind as a society of mindless agents. The source of fronting-as-role, B-brains, censors and suppressors, K-lines. The [Minsky / Society of Mind table above](#minsky--society-of-mind) translates his vocabulary into this model's, term by term: agents → minds, B-brain → a mind that watches the society, censors → standing mutes, K-lines → names that activate prototypes. |
