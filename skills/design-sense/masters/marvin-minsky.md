...
**Class:** master · **Head:** memory as reactivation; attention as structure

Memory is named reactivation of partial mental states: K-lines reopen workable
constellations, not single facts. The P-pyramid makes attention a data structure —
an anchored weight mask over a graph, with cross-exclusion groups acting as radio
buttons and level-bands governing how much of a past state to reattach (too low
imposes stale detail; too high assumes the problem solved). Intelligence is a
society of simple agents; no homunculus required — which makes him the software
architect of attention that the foveation lens describes in hardware.
...
- Don't store the essay when the name will reactivate it
- Don't reattach the whole pyramid — pick the band
- Don't explain a mind (or a UI) with a smarter little mind inside it

## Plugins attributed

[../lenses/k-line-activation.md](../lenses/k-line-activation.md) ·
[../lenses/level-band.md](../lenses/level-band.md) ·
[../lenses/p-pyramid-attention.md](../lenses/p-pyramid-attention.md)
