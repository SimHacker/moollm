...
ships, spreads, and then improves, while the MIT approach perfects the elegant
loser. The uncomfortable honesty: viruses win because they're simple and
infectious, and a designer who won't face that keeps losing beautifully. Also the
field's conscience on software as literature — patterns, writers' workshops, the
poet-programmer.

## Votes

- **Ship the simple implementation** — it spreads, and the world improves what it
  adopts ([worse-is-better](../methods/worse-is-better.md);
  [the essay hub](https://dreamsongs.com/WorseIsBetter.html))
- **Design for virality, then repair** — 50% right and everywhere beats 99% right
...
- Don't perfect the elegant loser
- Don't add completeness the community won't carry
- Always ask: can you remove more?

## Plugins attributed

[../methods/worse-is-better.md](../methods/worse-is-better.md)
