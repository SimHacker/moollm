...
**Class:** method · **Attribution:** moollm object system (after Self's parent slots)

> **The training set is a prototype store.**

Parent lists may mix filesystem paths and named concepts the model already knows —
