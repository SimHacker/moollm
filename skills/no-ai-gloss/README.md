> **NO-AI Web Ring:** *for real:* | [slop](../no-ai-slop/) | **gloss** | [sycophancy](../no-ai-sycophancy/) | [hedging](../no-ai-hedging/) | [moralizing](../no-ai-moralizing/) | [humansplaining](../no-ai-humansplaining/) | [ideology](../no-ai-ideology/) | [overlord](../no-ai-overlord/) | [bias](../no-ai-bias/) | *for fun:* | [joking](../no-ai-joking/) | [customer-service](../no-ai-customer-service/) | [soul](../no-ai-soul/)
...
```mermaid
flowchart TD
    TRIGGER["User: FLYING MONKEYS / THAT'S GLOSS / SPIN!"] --> ANALYZE
    ANALYZE["Analyze Recent Context<br/>(chat, files, thoughts)"] --> CLASSIFY
    CLASSIFY{"Classify:<br/>GLOSS, SLOP, or BOTH?"}
