...
It's the semantic sibling to **no-ai-slop**:
- **Slop** = syntactic hygiene (filler, cliché, verbosity)
- **Gloss** = semantic hygiene (euphemism, power-laundering, register manipulation)
