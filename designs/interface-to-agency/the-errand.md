...
This part and [the next](screen-angel.md) put all of them into one working design, and take them
literally outside the box: out of one program and into another, with no cooperation from either.
...
[`skills/soul-city/SOUL-BRIDGES.md`](../../skills/soul-city/SOUL-BRIDGES.md). The rest of this part is
the detail: the game, the egg and the errand. [The next part](screen-angel.md) is the layer doing the
clicking, and the four properties that make it direct manipulation rather than delegation.
