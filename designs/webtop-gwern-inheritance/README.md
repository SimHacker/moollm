...
| [MEMORY-PALACE-PIE-MENUS.md](MEMORY-PALACE-PIE-MENUS.md) | Navigation as parameter entry: rooms inherit through declared doors (Self parent slots; dynamic doors = computed parents), doors are reified forms (key/knock/password/payment rituals), every step pushes a history frame |
