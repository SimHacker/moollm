...
| **sim-obliterator/** | PSYCHOPOMP-AND-THE-BIFROST, BATTLE-PLAN, BRIDGE, IFF-LAYERS, THE-UPLIFT, THE-PET-SHOP, ANGEL-EVENT-BUS, README, *.yml | **ARCHIVED** — moved | Protocol went to `skills/soul-city/`; code and per-game work to MicropolisCore. Both the designs and the retired skill now live under [`archive/sim-obliterator/`](../archive/README.md), which carries the replacement table. |
