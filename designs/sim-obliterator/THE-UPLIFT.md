...
| **[Pet Shop / Vet](THE-PET-SHOP.md)** | Heal the guinea pig (and you), adopt, train, revive — the living counterpart of the Tombstone Studio | Name it, diagnose *why* it's sick, hand you a maintenance book; even generate & hot-patch a bespoke guinea pig | Edited pet `person_data` + cage object attributes, or a freshly-cloned object spliced into the save |
