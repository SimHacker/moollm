# 🕸️ The Dusty Attic — Adventurer's Storage

> *"Take what you need. Leave what you find."*
> *"Mind the edge cases."*

**Dusty boxes, forgotten treasures, weird buffs, Leela quality.**
...
Slanted roof beams disappear into shadow. Dust motes dance in shafts of light from a grimy dormer window. The air smells of old paper, mothballs, and mystery. Something skitters in the darkness. Probably mice. *Probably.*
...
| **The Skittering Thing** | Listen carefully | Probably mice. Definitely not anything else. |
| **The Sheet-Covered Thing** | Pull the sheet | ??? — nobody has done this yet |

*Inherits from: technical debt, forgotten features, attic lore, the things we don't talk about*
...
|--------|------|-------------|
| **Leela Catalog (Vintage)** | [leela-catalog-vintage.yml](leela-catalog-vintage.yml) | "Must have left this up here years ago..." Edition 12, still readable. |

*Found behind the holiday box. 35 editions old. Still works perfectly.*
...
|----------|-------|
| **Mode** | Storage |
| **Capacity** | Infinite (attics are like that) |
| **Accepts** | Furniture, antiques, forgotten things, holiday decorations, adventure gear |

---

## 🔝 The Skylight

A hatch in the ceiling leads to the rooftop terrace. On clear nights, starlight streams down. On rainy nights, you can hear the drops on the glass.

The skylight is always slightly ajar. For ventilation. Or for something else.
...
|-----------|-------------|
| ⬇️ Down | [../rooms/](../rooms/) — Ladder to hotel landing |
| ⬆️ Up | [../rooftop/](../rooftop/) — Through the skylight |
