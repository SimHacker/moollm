...
```mermaid
flowchart TB
    subgraph Hotel["🏨 MOOLLM HOTEL"]
        Attic["🎒 Attic<br/>Adventurer's Storage"]
        Landing["🚪 Landing<br/>(you are here)"]
        
        R1["🐢 Room 1<br/>Constructionist"]
        R2["🧠 Room 2<br/>Society"]
        R3["🔍 Room 3<br/>Navigator"]
        R4["🌿 Room 4<br/>Conservatory"]
        R5["⚡ Room 5<br/>Speed of Light"]
        R6["🎷 Room 6<br/>YAML Jazz"]
        R7["☕ Room 7<br/>Bootstrap"]
        R8["🪞 Room 8<br/>Incarnation"]
    end
    ...
    style Attic fill:#8b5cf6,color:#fff
    style Landing fill:#f59e0b,color:#fff
    ...
    style R6 fill:#8b5cf6,color:#fff
    style R7 fill:#78716c,color:#fff
    style R8 fill:#ec4899,color:#fff
```
