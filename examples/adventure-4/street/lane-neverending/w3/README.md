...
flowchart TB
    ...
    W3 --> |"walk west"| Portal["The transition"]
    Portal --> |"seamlessly"| E3["E3 (far east)"]
    
    E3 --> |"keep walking west"| Eventually["...eventually..."]
    Eventually --> W3
```
...
|-----------|-------------|-------|
| ⬅️ West | [e3](../e3/) | **THE LOOP** — arrives at far east |
| ➡️ East | [w2](../w2/) | Landmark quarter |
