...
<details>
<summary><strong>📖 The Guestbook Ceremony — 12 guests sign The GG's Memory</strong></summary>

## 📖 The Guestbook Ceremony

**GRIM** produced an ancient leather-bound tome: **The GG's Memory**.
...
```yaml
# pub/guestbook/ - The GG's Memory
guestbook:
  name: "The GG's Memory"
  keeper: grim
  signatures: [12 guests tonight]
  traditions:
    - "Names in the book are remembered by the GG itself"
