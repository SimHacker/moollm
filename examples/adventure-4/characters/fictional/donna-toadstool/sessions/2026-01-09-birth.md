...
boot_sequence:
  files_read:
    ...
    - ../../../../garden/ROOM.yml           # Starting room definition
...
The player awakens in [start/](../../../../garden/) — the Chamber of Commencement. A sacred space carved from living rock, soft sourceless light suffusing the chamber. The walls bear scratched initials of adventurers past:
...
room:
  ...
  exits:
    ...
    south: ../pub/           # The Gezelligheid Grotto
...
The [brass lamp](../../../../garden/lamp.yml) settles into inventory with the weight of tradition. Its base is covered in tiny scratched initials — marks of those who faced the darkness and returned.
...
**Rooms visited:**
- [../../../../garden/ROOM.yml](../../../../garden/ROOM.yml) — Chamber of Commencement
...
Meanwhile, [BISCUIT](../../../animals/dog-biscuit/CHARACTER.yml) comes BOUNDING from the [Cat Cave](../../../../pub/bar/cat-cave/ROOM.yml), tail wagging, to join the entourage!

<details open>
<summary>📂 <strong>Biscuit joins the party — instant friendship formed</strong></summary>

```yaml
# In ../../animals/dog-biscuit/CHARACTER.yml
relationships:
  donna-toadstool:
...
Word spreads. Something TREMENDOUS is happening at the Gezelligheid Grotto.

**NEW ARRIVALS:**

| Character | From | Reaction |
|-----------|------|----------|
| [Biscuit](../../../animals/dog-biscuit/) | Cat Cave | MAXIMUM DOG ENTHUSIASM |
| [Palm](../../../animals/monkey-palm/) | Stage Nook | "Interesting. Terrifying. But interesting." |
...
A **UFO** descended outside the Gezelligheid Grotto, carrying:
...
<details open>
<summary><strong>📖 The Guestbook Ceremony — 12 guests sign The Grotto's Memory</strong></summary>

## 📖 The Guestbook Ceremony

**GRIM** produced an ancient leather-bound tome: **The Grotto's Memory**.
...
<details open>
<summary>📂 <strong>File created: pub/guestbook/</strong></summary>

```yaml
# pub/guestbook/ - The Grotto's Memory
guestbook:
  name: "The Grotto's Memory"
  keeper: grim
  signatures: [12 guests tonight]
  traditions:
    - "Names in the book are remembered by the Grotto itself"
    - "All signatories are welcomed back, always"
  magic_properties:
    pages: infinite  # The book grows as needed
```

See: [`../../../../pub/guestbook/`](../../../../pub/guestbook/)
