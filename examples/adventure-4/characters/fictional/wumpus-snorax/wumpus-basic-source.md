# Hunt the Wumpus — Original BASIC Source (1973)

By **Gregory Yob**, published in *Creative Computing* (October 1975) and *The Best of Creative Computing* (1976).

## Historical Significance

Hunt the Wumpus is one of the most influential early computer games:

- **First non-grid adventure game** — Yob was annoyed by hide-and-seek games on 10x10 grids
- **Dodecahedron topology** — 20 caves as vertices of a Platonic solid (his favorite)
- **Environmental storytelling** — "I smell a wumpus!" is gaming's original proximity warning
- **Cited as early survival horror** — though the player hunts rather than is hunted
- **Listed in Time's All-Time 100 Greatest Video Games** (2012)
...
Each cave connects to exactly 3 others. No compass directions — just numbered tunnels.

## Game Elements

| Element | Count | Warning | Effect |
|---------|-------|---------|--------|
| Wumpus | 1 | "I SMELL A WUMPUS!" | Eats you on entry (or moves) |
| Pits | 2 | "I FEEL A DRAFT!" | Instant death |
...
### Cave Adjacency (Lines 130-160)
The DATA statements encode the dodecahedron. Each cave's 3 neighbors:
...
- Yob, Gregory. "Hunt the Wumpus." *Creative Computing*, October 1975.
- Ahl, David, ed. *The Best of Creative Computing*, Vol. 1. Creative Computing Press, 1976.
