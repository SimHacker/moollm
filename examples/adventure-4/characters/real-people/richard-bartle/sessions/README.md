...
```mermaid
flowchart TB
    subgraph DAY1["📅 January 22, 2026"]
        direction TB
        A["🍺 11:30 — The Pub<br/><i>Agreement to incarnate</i>"]
        B["🎴 12:45 — Cards as Actors<br/><i>The architecture insight</i>"]
        C["✨ 13:15-15:30 — Building<br/><i>Card, photos, familiars, profiles</i>"]
        D["🐉 16:00-17:00 — Awakening<br/><i>Heuristic gets powers, Scott McCloud visits</i>"]
        E["📸 18:00 — Visual Pipeline<br/><i>8 selfies, the BUNNY BACKFIRE</i>"]
        F["📊 20:00 — Deep Probe<br/><i>Harper's Numbers, meta-analysis</i>"]
