...
flowchart TB
    subgraph FOUNDATION["🏗️ FOUNDATION (Jan 14-15)"]
        direction TB
        A["🍺 Marathon Session<br/><i>The original 241KB epic</i>"]
        B["🐱 Cat Cave Incarnation<br/><i>Kittens get emoji souls</i>"]
        C["🍻 99 Bottles<br/><i>Speed of Light benchmark</i>"]
    end
    ...
    subgraph AWAKENING["✨ AWAKENING (Jan 20-21)"]
        ...
        F["🔗 K-Line Safari<br/><i>Minsky's maze made manifest</i>"]
    end
