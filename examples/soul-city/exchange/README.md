# The Soul City Exchange

**Import your past. Export your future.**

The Exchange is Soul City's import/export hub — a reimagining of The Sims Exchange (thesims.ea.com, circa 2000-2008) where players shared families, houses, and objects. The original Exchange was a website. This one is a directory structure with pipelines.
...
6. **Placement**: Character moves to `characters/` as a Soul City citizen
