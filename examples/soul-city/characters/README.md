...
This directory contains all imported and created Sims living in Soul City. Each character has the full MOOLLM character structure: CHARACTER.yml (the soul), CARD.yml (the interface), GLANCE.yml (the quick scan), and README.md (the deep story).
...
### Singles
*Various sources — the unattached citizens of Soul City*
