...
**Connecting Soul City to the Gezelligheid Grotto.**

The Bridge is the portal between Soul City (The Sims universe) and Adventure 4 (the MOOLLM text adventure world). Through the Bridge, Sims can visit the Grotto and adventure characters can visit Soul City. Two worlds, one MOOLLM.

## Why a Bridge?

Soul City and Adventure 4 are both MOOLLM worlds — they use the same character system, the same YAML Jazz conventions, the same Mind Mirror personality framework. The difference is context: Soul City is a life simulation. Adventure 4 is a text adventure. Characters from either world are compatible because they share the same data format.

The Bridge makes this compatibility navigable. A Sim from Newbie Heights can walk through the portal and appear in the Grotto's pub. An NPC from the adventure can visit Soul City and explore the neighborhoods. Cross-pollination of characters and stories.
...
- In Soul City: a mysterious doorway in the Custom District
...
### Adventure Characters Visit Soul City
...
- [Soul City](../ADVENTURE.yml) — The origin world
