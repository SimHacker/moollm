...
The Sims 1 lot system uses a grid-based floor plan with tiles, walls, floors, and object placements. The House Builder generates lot layouts from natural language descriptions, producing YAML floor plans compatible with both Soul City and (via SimObliterator) the original game.
