...
The Soul City Face Editor generates character appearances from personality descriptions and CHARACTER.yml data. Instead of painting pixels, describe the character and generate their look.
